...
const TONE_DESCRIPTIONS = {
  funny: 'ضحك مصري خفيف بشكل طبيعي، هزار باين كأنه طالع تلقائي من شخص فعلاً مش من AI, مع استخدام تعبيرات عامية مرحة وشعبية',
  believable: 'كلام مصري بسيط واقعي فيه إحساس بالصدق والإلتزام من غير ما يبقى رسمي ويكون السبب تقني أو ظروف يومية مهمة جداً جداً',
...
اكتب عذر واحد أو سبب واحد فقط يكون باللهجة المصرية اليومية وبأسلوب طبيعي جدًا من غير مقدمات رسمية
العذر يكون ${toneDesc}
اربط العذر بنوعه: ${excuseType}، سواء كان بسبب ضغط شغل، مشكلة تقنية، ظروف مفاجئة، أو موقف يومي حقيقي
      ...
      return NextResponse.json(
        {
          ...
          excuse: 'بص مش عارف أقولك ايه بس الأبليكيشن الي المفروض يطلعلك العذر مش شغال دلوقتي بس هحاول في اسرع وقت ألم الدنيا متقلقش تعالا بعد ساعة بس تكون الدنيا هدت شوية ومتقلقش هظبطك.'
        },
        { status: 200 }
      );
    }
