...
async function generateExcuseText(tone: string, excuseType: string): Promise<string> {
  ...
  try {
 const prompt = `علميا يكون فيه طرق اقناع كويسة بدون مقدمات كأني هبعته واتساب ،انت خبير في كتابة أعذار للفريلانسرز باللهجة المصرية اليومية،انت بني أدم مصري إتكلم بطريقة بشري بيتكلم شات واتساب مصري بين الفريلانسر وعميله، هدفك توليد عذر واحد من جملة واحدة أو جملتين ومقنع جدًا.
